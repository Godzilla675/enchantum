...
namespace details {
  ...
  ENCHANTUM_INLINE_VAR constexpr std::size_t prefix_length_or_zero = 0;

  template<typename E>
  ENCHANTUM_INLINE_VAR constexpr auto prefix_length_or_zero<E, decltype((void)enum_traits<E>::prefix_length)> = std::size_t{
