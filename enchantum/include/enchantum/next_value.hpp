...
ENCHANTUM_INLINE_VAR constexpr details::next_value_functor<1>           next_value{};
ENCHANTUM_INLINE_VAR constexpr details::next_value_functor<-1>          prev_value{};
ENCHANTUM_INLINE_VAR constexpr details::next_value_circular_functor<1>  next_value_circular{};
ENCHANTUM_INLINE_VAR constexpr details::next_value_circular_functor<-1> prev_value_circular{};
